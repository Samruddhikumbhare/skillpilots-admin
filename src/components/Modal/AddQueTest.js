// start on 6 march 2025 by medha
...
const AddQueTest = ({
  ...
  const [formData, setFormData] = useState({
    ...
    answer: "",
    correctAnswers: [],
    marks: editData.marksPerQuestion,
  });
  ...
  // on  chnage event for questio level
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await axios
      .post(api + `/newskill/addQuestion/${selectedRowId}/${selectedTestId}`, formData)
      .then(async (response) => {
        handleClose();
        Swal.fire({
          icon: "success",
          title: "Success",
          text: "Question Add Successfully.",
